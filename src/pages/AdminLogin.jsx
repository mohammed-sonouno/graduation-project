  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (user) {
        ...
        if (isStaff(user)) {
          navigate(getLoginRedirectPath(user), { replace: true, state: { fromLogin: true } });
        } else {
          setError("Use Student Login for this account.");
        }
      } else {
        ...
        <div className="w-full max-w-md mx-auto">
          <div className="rounded-2xl border border-slate-200/80 bg-white shadow-md p-8 md:p-10">
            ...
            <p className="mt-2 text-center text-sm text-slate-600 leading-relaxed">
              Sign in with your staff email and password (admin, association leader, supervisor, or dean).
            </p>
            ...
            <form className="mt-8 space-y-5" onSubmit={handleSubmit}>
              <div>
                ...
                <input
                  ...
                  placeholder="e.g. admin@najah.edu or ieee@najah.edu"
