...
import { isStaff, isAdmin, isCommunityLeader, canAccessManageEvents } from "../utils/permissions";
    ...
    <div className="min-h-screen bg-[#f7f6f3] text-slate-900">
      ...
      <div className="max-w-screen-2xl mx-auto px-6 lg:px-10 py-8">
        ...
        <div className="rounded-xl border border-slate-200 bg-white shadow-sm overflow-hidden mb-8 border-l-4 border-l-[#00356b]">
          <div className="p-6">
            ...
            <p className="mt-2 text-slate-600 text-sm leading-relaxed">
              You are logged in with the <strong>admin</strong> role. Use the links below to manage events, approve submissions, and view the dashboard.
            </p>
          </div>
        </div>
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          ...
          {(isAdmin(user) || isCommunityLeader(user)) && (
            <Link
            ...
            >
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm text-slate-500">Review predictions, apply corrections, and retrain the sentiment model.</p>
                </div>
              </div>
            </Link>
          )}
